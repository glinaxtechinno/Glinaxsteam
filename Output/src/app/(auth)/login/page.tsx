    ...
    <div className="w-full max-w-md animate-fade-in-up">
      <div className="bg-surface-raised border border-surface-border rounded-2xl p-8 shadow-lg">
        ...
        <button
          type="button"
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-surface-border bg-surface-overlay text-sm font-medium text-text-primary hover:border-primary hover:bg-surface-overlay/80 transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={() => {
            alert("Google Sign-In: wire NEXT_PUBLIC_GOOGLE_CLIENT_ID in .env.local to activate.");
          }}
        >
